(function (factory) {
  ...
  const investmentChartInit = () => {
    ...
    $investmentChartList.forEach($investmentChart => {
	    ...
	    const hw_invest_fil = investmentChartParent.querySelector('#hw_invest_fil').textContent;
	    const total_budget_fil = investmentChartParent.querySelector('#total_budget_fil').textContent;
        ...
        series: [
          {
            ...
            data: [
              { value: hw_invest_fil, name: '나의 투자FIL' },
